  ...
  export default function CanvasCard({
      ...
      return (
          <div className="w-full group">
              ...
              <div className="mt-3 ml-auto mr-0 bg-black p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300" 
                   style={{ width: 'calc(100% - 2rem)' }}>
                  <h3 className="text-lg font-medium text-white-900 mb-1">{title}</h3>
                  <div className="flex items-center justify-between text-sm text-white-600">
                      <span>{timeAgo}</span>
                      <span className="text-white-500">작가</span>
                  </div>
              </div>
          </div>
      );
